...
2. In `package.json`: set `"name": "@p2pay/<name>"`
...
5. In the host app's `package.json`: add `"@p2pay/<name>": "workspace:*"`
6. In the host app's `nuxt.config.js`: add `'@p2pay/<name>'` to `modules`
7. Run `pnpm install`
